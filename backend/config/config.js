module.exports = {
  ...
  ALLOWED_ORIGINS: (process.env.ALLOWED_ORIGINS || 'http://localhost:5173,http://localhost:5174,http://localhost:8083')
    .split(',')
    .map(s => s.trim())
  ,
  ...
  ,
  DEV_AUTH_PERMISSIVE: process.env.DEV_AUTH_PERMISSIVE === 'true'
};
