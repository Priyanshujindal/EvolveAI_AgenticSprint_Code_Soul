...
export default function NotFound() {
  return (
    <div className="text-center py-16">
      <Seo title="404 | Page not found | Health Sphere" description="The page you requested could not be found." url="https://evolveai-backend.onrender.com/404" canonical="https://evolveai-backend.onrender.com/404" noIndex={true} />
