        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          <div className="hidden md:flex relative overflow-hidden rounded-xl border border-brand-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-8">
            <div className="relative z-10 my-auto">
              <div className="inline-flex items-center gap-2 rounded-full border border-brand-200/70 dark:border-slate-700 px-3 py-1 text-xs text-brand-700 dark:text-blue-200 bg-brand-50/60 dark:bg-slate-800 mb-4">Create account in minutes</div>
                ...
                <form className="space-y-4" onSubmit={handleEmailSignup}>
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <Input id="name" type="text" placeholder="Jane Doe" value={name} onChange={e => setName(e.target.value)} autoComplete="name" disabled={submitting} className="pl-10" />
                    </div>
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} autoComplete="new-password" disabled={submitting} className="pl-10" />
                    </div>
                  </div>
