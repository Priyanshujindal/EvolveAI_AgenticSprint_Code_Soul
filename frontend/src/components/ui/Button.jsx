...
export default function Button({ variant = 'primary', className = '', disabled = false, children, ...props }) {
  const base = 'inline-flex items-center justify-center rounded-md transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed px-3.5 py-2.5 text-sm font-medium shadow-sm';
  const variants = {
    primary: 'bg-gradient-to-tr from-blue-600 to-indigo-600 text-white hover:from-blue-600 hover:to-blue-700 focus:ring-blue-600',
